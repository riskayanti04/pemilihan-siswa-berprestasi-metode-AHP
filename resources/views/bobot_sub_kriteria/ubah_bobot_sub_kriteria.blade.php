    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="/bobot_sub_kriteria/{{$data[0]}}">Bobot Sub Kriteria</a></li>
...
@endif
  <!-- /.card-header -->
  <div class="card-body">
    <form role="form" method="post" action="{{ route('bobot_sub_kriteria.store') }}">
    @csrf
        <div class="card-body">
          <div class="row">
            <div class="col-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$data[1]}}" name="kode_sub_kriteria_1" readonly>
              </div>
            </div>
            <div class="col-2">
              <div class="form-group">
            ...
            <div class="col-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{$data[2]}}" name="kode_sub_kriteria_2" readonly>
              </div>
            </div>
          </div>
