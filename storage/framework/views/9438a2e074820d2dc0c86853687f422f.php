<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
            <!-- /.card-header -->
            <div class="card-body">
            <form role="form" method="post" action="<?php echo e(route('bobot_kriteria.store')); ?>">
            <?php echo csrf_field(); ?>
                <div class="card-body">
                  <div class="row">
                    <div class="col-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($data[0]); ?>" name="kode_kriteria_1" readonly>
                      </div>
                    </div>
                    <div class="col-2">
                      <div class="form-group">
                    ...
                    <div class="col-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($data[1]); ?>" name="kode_kriteria_2" readonly>
                      </div>
                    </div>
                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ahp\resources\views/bobot_kriteria/ubah_bobot_kriteria.blade.php ENDPATH**/ ?>