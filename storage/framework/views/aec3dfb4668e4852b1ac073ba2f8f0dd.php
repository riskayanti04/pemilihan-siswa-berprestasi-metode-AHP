              ...
              <td><?php echo e($var1); ?></td>
                <?php $__currentLoopData = array_keys($m_1[$var1]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($m_1[$var1][$var2]): ?>
                    <td data-href='/bobot_kriteria/<?php echo e($var1); ?>,<?php echo e($var2); ?>/edit' class="clickable-row pointer bg-success">
                      <?php echo e($m_1[$var1][$var2]); ?>

                    </td>
                    <?php else: ?>
                    <td data-href='/bobot_kriteria/<?php echo e($var1); ?>,<?php echo e($var2); ?>/edit' class="clickable-row pointer bg-danger">
                      null
                    </td>
                  <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ahp\resources\views/bobot_kriteria/nilai_bobot_kriteria.blade.php ENDPATH**/ ?>